...
export default function Home() {
  ...
  console.log(cells);
  console.log('====================================');
  const grid = Array.from({ length: 1000 }, (_, index) => index + 1);
  return (
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-center  ">
      ...
      <div class=" grid items-center max-w-4xl grid-cols-2 gap-4 mx-auto mt-12 md:mt-20 md:grid-cols-4  ">
        ...
        {/* <div className="grid-cols-10 gap-1"> */}
        {grid.map((_, idx) => (
        ...
        <div class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
          <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
            <div class="flex items-center justify-between ">
              <div>
                <h3 class="text-lg font-semibold text-slate-800">Current Record</h3>
                <p class="text-slate-500">Grid Contain Value</p>
              </div>
